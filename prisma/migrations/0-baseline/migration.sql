...
CREATE TABLE `bookmarkEntries` (
    ...
    INDEX `bookmarkEntries_userId_createdAt_key`(`userId`, `createdAt`),
...
CREATE TABLE `captionEntries` (
    ...
    INDEX `captionEntries_videoId_index_key`(`videoId`, `index`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `practiceActions` (
    ...
    INDEX `practiceActions_deckId_createdAt_key`(`deckId`, `createdAt`),
...
CREATE TABLE `practiceEntries` (
    ...
    INDEX `practiceEntries_deckId_scheduledAt_key`(`deckId`, `scheduledAt`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
